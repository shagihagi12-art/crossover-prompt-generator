...
### キャラ初回登場時:
外見を具体的に描写（服装、体型、髪型、持ち物、画風）

### 効果音:
Sound effect text: "効果音"

### 末尾のStyle指定（必ず含める）:
- Style: {作品Aの画風特徴} meets {作品Bの画風特徴}, contrasting art styles coexisting in the same panels.
